  ...
  return (
    <div className='my-10'>
        <div className='text-center text-3xl py-8'>
            ...
            <p className='w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum necessitatibus iusto dolores, eligendi voluptatum voluptates? Obcaecati, consequatur nisi! Harum voluptas similique recusandae ipsam fugiat consequatur accusamus perspiciatis totam ut distinctio.</p>
